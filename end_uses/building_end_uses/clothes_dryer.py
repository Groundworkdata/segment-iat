...
class ClothesDryer:
    ...
    def _get_retrofit_scenario(self) -> int:
        ...
        return retrofits.get("dryer_resstock_scenario")
    ...
    def _get_energy_consump_retrofit(self) -> pd.DataFrame:
        ...
        resstock_retrofit_fuel = self._resstock_metadata["in.clothes_dryer"]

        if "propane" not in resstock_retrofit_fuel.lower() and retrofit_fuel=="propane":
